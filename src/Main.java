public class Main {
    ...
    public static void main(String[] args) {
        ...
        String paymentPerMonth = String.format("Ежемесячный аннуитетный платеж по Вашему кредиту на сумму " + creditSum + " руб. на " + creditPeriod + " год(а) по ставке " + creditRate + " % годовых составит: %.0f руб.", sumPerMonth);
